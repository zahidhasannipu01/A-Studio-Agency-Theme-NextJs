...
const Video = () => {
  return (
    <Container>
      <div className="mb-30 grid grid-cols-2 items-center relative">
        <div className="w-[550px] h-[372px] rounded-3xl overflow-hidden object-cover relative">
          <div className="">
            <Image
              src={VideoImage}
              alt="video"
            ...
            <div>
              <Image
                src={playbutton}
                alt="play button"
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 cursor-pointer scale-100 hover:scale-105 duration-300 animate-pulse"
              />
            </div>
          </div>
        </div>
